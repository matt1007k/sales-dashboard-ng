...
import { TotalSummary } from '../../../../domain/model/total-summary';
...
@Component({
  ...
  template: `
    @for (summary of data; track summary.title) {
        ...
        <div class="card mb-0">
          <div class="flex justify-between mb-4">
            <div>
              ...
              <div class="text-surface-900 font-bold text-4xl">
                {{ summary.total }}
              </div>
            </div>
            <div
              ...
              [ngClass]="summary.iconBgColor"
            >
              <i class="!text-xl" [ngClass]="[summary.icon, summary.iconColor]">
                <!-- [ngClass]="{
                  'text-amber-500': summary.icon > 4,
                  'text-blue-500': summary.total <= 4,
                }" -->
              </i>
            </div>
          </div>
          <span class="text-primary font-medium"
            >{{ summary.countToday }} new
          </span>
...
export class StatsWidget {
  ...
  loadSummary = effect(() => {
    ...
    this.dashboardService.getTotalSummary().subscribe((data) => {
      this.data = data;
